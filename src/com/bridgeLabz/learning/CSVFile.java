...
public class CSVFile { 
	...
	public static void writeToFile() throws CsvDataTypeMismatchException, CsvRequiredFieldEmptyException, IOException{
		...
		try {
		 ...
		 myList.add(new Details("Umesh","deora","talkiya","jaitaran","raj",1,(long) 1234567890,"umesh@gmail.com"));
		 myList.add(new Details("mahesh","paliwal","phalodi","jodhpur","raj",1,(long) 1234567890,"mahesh@gmail.com"));
		 myCsv.write(myList);
	}
